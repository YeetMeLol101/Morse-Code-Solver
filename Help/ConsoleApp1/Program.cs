        ...
        private static void ConvertMorseCode(int[] Dash, char[] Letter, int[] Dot)
        {
            ...
            for (int i = 0; i < MorseCodeStringLength; i++)
            {
                ...
                while (!LetterEnd)
                {
                    ...
                    if (Symbol != SPACE && Symbol != EOL)
                    {
                        SymbolString = SymbolString + Symbol;
                    }
                    if (Symbol == SPACE && MorseCodeString[i+1] != SPACE)
                    {
                        LetterEnd = true;
                        i += 4;
                    }
                    ...
                    else if (MorseCodeString[i] == SPACE && MorseCodeString[i + 1] == SPACE)
                    {
                        LetterEnd = true;
                        i += 3;
                    }
                ...
                PlainTextLetter = Decode(SymbolString, Dash, Letter, Dot);
            }
